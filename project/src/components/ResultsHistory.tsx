    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Exam History</h2>
          <p className="text-gray-600 text-sm sm:text-base">View your past exam attempts and results</p>
        </div>
              ...
              >
                ...
                {attempt.status === 'submitted' && (
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-4 pt-4 border-t">
                    ...
                    <div className="text-center">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1">Passing Marks</p>
                      <p className="text-lg sm:text-2xl font-bold text-gray-800">
                        {attempt.exams?.passing_marks}
                      </p>
                    </div>
                    <div className="text-center">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1">Result</p>
                      {attempt.is_passed ? (
